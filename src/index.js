                    ...
                    <div className="main-content_main-title">
                        {Post.map((UserPost, index) =>
                            <div className="user-post">
                                ...
                                <div className="mim" style={{ backgroundImage: UserPost.src }} onClick={() => ShowPostDetail(UserPost)}></div>
                                <div className="react">
        ...
        <div className="dangmim-overlay">
            <div className="showpost-content">
                <div className="dangmim-header">
                    ...
                    <img src="source/exit.png" className="dangmim-exit" onClick={() => { post = ''; ReactDOM.render(<HomePage />, document.getElementById("root")) }} />
                </div>
